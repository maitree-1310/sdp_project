package com.techbazar.controller;
...
import com.techbazar.exception.OrderException;
import com.techbazar.exception.UserException;
import com.techbazar.modal.Order;
import com.techbazar.repository.OrderRepository;
import com.techbazar.response.ApiResponse;
import com.techbazar.response.PaymentLinkResponse;
import com.techbazar.service.OrderService;
import com.techbazar.service.UserService;
import com.techbazar.user.domain.OrderStatus;
import com.techbazar.user.domain.PaymentStatus;
	...
	public ResponseEntity<PaymentLinkResponse>createPaymentLink(@PathVariable Long orderId,
		...
		Order order=orderService.findOrderById(orderId);
		 try {
		      ...
		      RazorpayClient razorpay = new RazorpayClient("rzp_test_QyJGqIFGGRcIwQ", "5YehkSgoAI5pbjIUCKTkSqVR");
